...
//float MassMin[NHFQA] = {1.6,1.6,1.7,2.0,5.0,5.0,5.1,2.9,9.0};
float MassMin[NHFQA] = {1.6,1.6,1.7,2.0,5.0,5.0,5.1,0.0,9.0};
float MassMax[NHFQA] = {2.0,2.0,2.1,2.5,5.5,5.5,5.6,3.2,10.0};
...
int QAG4Decayer::process_event(PHCompositeNode *topNode)
{
			...
			iter != range.second; ++iter)
	{
		...
		if ((ParentTrkId > 0 || abs(gflavor) == abs(ParentPDGID)) && VtxToQA == true && abs(gflavor) == 11)   //include only dielectrons for Jpsi and upsilon
		{
